...
const countryList = [
    ...
    const validateEmailDomain = (email) => {
        ...
        const validDomains = ['gmail.com', 'email.com', 'outlook.com', 'yahoo.com'];
    ...
    const handleSubmit = (e) => {
        ...
        if (isFormComplete) {
            ...
            alert('Please complete all required fields and ensure email is valid.');
        }
    };
    ...
    return (
        <div className="p-6 bg-orange-100 rounded-lg shadow-md border border-gray-200">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <div className="w-full">
                        ...
                        <Select
                            options={countryList}
                            value={
                                countryList.find((option) => option.value === formData.nationality) || null
                            }
                ...
                {/* Submit Button */} <div className="text-center">
                    <button
                        type="submit"
