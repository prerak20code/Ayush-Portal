    ...
    <div className="bg-gray-100 flex items-center justify-center p-6">
      ...
      <div className="flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden max-w-5xl w-full">
        ...
        <div className="flex-1 bg-gray-200 flex flex-col justify-center items-center p-8 ">
          ...
          <h2 className="text-4xl font-bold text-gray-800 mb-2">Ayush Startup</h2>
          <h3 className="text-xl font-semibold text-gray-600 mb-4">User Registration Portal</h3>
          <img src={AyushLogo} alt="Ayush Logo" className="max-w-xs w-full md:block hidden" />
        </div>
