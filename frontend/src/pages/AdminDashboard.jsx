        ...
        const fetchStartups = async () => {
            try {
                const dummyData = [
                    ...
                    {
                        id: 30,
                        name: 'Ayurveda Ventures',
                        sector: 'Ayurveda',
                        registeredDate: '2023-12-19',
                        status: 'Rejected',
                    },
                    {
                        id: 31,
                    ...
                    {
                        id: 45,
                        name: 'Complete Health Solutions',
                        sector: 'Homoeopathy',
